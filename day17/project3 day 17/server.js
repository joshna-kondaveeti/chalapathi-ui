...
const Matriuser = require("./model/gdb");//gdb groomdata,Matriuser--used for storing gdb data 
let app = express();

mongoose.connect("mongodb://localhost/matrimony");//matrimony database name
...
app.post("/register", async (req, res) => {
    const user = await Matriuser.create({
      ...
      age:req.body.ages,//ages is alliesname of age
      dob:req.body.dob
    });
